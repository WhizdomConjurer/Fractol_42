...
/*   Updated: 2025/11/12 17:22:28 by puzzlesanal      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_error(void)
{
	...
	ft_putstr_fd(" | Press [Q-Y] keys to change the color of fractal   |\n", 1);
	ft_putstr_fd(" | Press [A-H] keys to change the color of fractal   |\n", 1);
	ft_putstr_fd(" | Use mouse scroll to zoom in & out of the fractal  |\n", 1);
